...
import AltTypingArea from './AltTypingArea'; // Import the TypingArea component
import AltCircularProgressBar from './AltCircularProgressBar';
    ...
    return (
        <div className='flex justify-center items-center h-screen' style={{ background: currentTheme.background, color: currentTheme.textColor }}>
            <div className='flex w-screen'>
                <div className="flex-none w-[60vw] p-4 ml-10 mt-20">
                    <input
                        type="text"
                ...
                <div className='flex flex-col justify-center items-center flex-grow p-4 mr-10'>
                    <div className='mb-4'>
